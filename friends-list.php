			...
			<div class="row" >
				<div class="col-sm-2">
					<div data-spy="affix" data-offset-top="60" data-offset-bottom="200">
						<ul class="nav nav-pills nav-stacked">
							...
							<li role="presentation" class="active"><a href="friends-list.php">Friends List</a></li>
				...
				<div class="col-sm-offset-1 col-sm-7">
					<ul class="nav nav-tabs">
						<?php 
							$fcount = $query->get_friends_count($logged_user_id);
							$subcount = $query->get_subs_count($logged_user_id);
							$scount = $query->get_subscribe_count($logged_user_id);
						?>
						<li class="active"><a data-toggle="tab" href="#friends_list">Friends List <span class="badge"><?php echo $fcount; ?></span></a></li>
						<li><a data-toggle="tab" href="#u_subscription">You Subscription <span class="badge"><?php echo $subcount; ?></span></a></li>
						<li><a data-toggle="tab" href="#u_subs">Subscribers <span class="badge"><?php echo $scount; ?></span></a></li>
					</ul>
					<div class="tab-content">
						<div id="friends_list" class="tab-pane fade in active">
							<?php $query->do_friends_list($friends); ?>
						</div>
						<div id="u_subscription" class="tab-pane fade">
							<?php $query->do_sub_list($logged_user_id); ?>
						</div>
						<div id="u_subs" class="tab-pane fade">
							<?php $query->do_sub_list_other($logged_user_id); ?>
						</div>
					</div>
				</div>
			</div>
